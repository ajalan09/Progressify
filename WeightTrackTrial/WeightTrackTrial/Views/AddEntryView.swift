    ...
    var body: some View {
        ...
        NavigationView {
            VStack {
                ...
                ExtractedView(addEntryVM: self.$addEntryVM, showFrontImagePicker: self.$showFrontImagePicker, showSideImagePicker: self.$showSideImagePicker, showBackImagePicker: self.$showBackImagePicker)
